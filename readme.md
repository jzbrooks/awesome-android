...
- [vgo](https://github.com/jzbrooks/vgo) - vgo is a tool and Gradle plugin for optimizing vector artwork files that helps ensure your vector artwork is represented compactly without compromising quality.
